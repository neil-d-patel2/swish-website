...
export function VaultShieldHero() {
  ...
  return (
    <div className="bg-black text-white min-h-screen">
      {!supabaseSession && (
        <div className="w-full bg-white/[0.06] border-b border-white/[0.08] px-4 py-2.5 flex items-center justify-center gap-3">
          <span className="text-sm text-white/60">Create your store and start selling</span>
          <button
            onClick={() => void signInWithGoogle()}
            className="flex items-center gap-2 bg-white text-black px-3 py-1 rounded-md text-xs font-medium hover:bg-gray-100 transition-colors cursor-pointer"
          >
